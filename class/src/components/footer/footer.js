...
const menuItems = [
    { id: 0, label: "홈", Icon: RiHome2Line, href: "./" },
    { id: 1, label: "검색", Icon: IoSearchOutline, href: "./search"},
    { id: 2, label: "예약", Icon: HiCalendar, href: "./reservation" },
    { id: 3, label: "커뮤니티", Icon: BiMessageRoundedDetail , href: "./community" },
